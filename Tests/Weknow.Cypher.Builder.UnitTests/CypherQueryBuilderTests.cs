...
namespace Weknow.Cypher.Builder.UnitTests
{
    public class CypherQueryBuilderTests
    {
        ...
        public void CypherQueryBuilder_Range_Test()
        {
            ...
            Assert.Equal(data[..3], builder[..3]);
            Assert.Equal(data[3..], builder[3..]);
            Assert.Equal(data[2..6], builder[2..6]);
            Assert.Equal(data[2..2], builder[2..2]);
        }
        ...
        public void CypherQueryBuilder_Range_End_Test()
        {
            ...
            Assert.Equal(data[..^3], builder[..^3]);
            Assert.Equal(data[^3..], builder[^3..]);
            Assert.Equal(data[^7..6], builder[^7..6]);
            Assert.Equal(data[^4..^2], builder[^4..^2]);
        }
