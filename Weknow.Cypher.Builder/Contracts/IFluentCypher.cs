...
namespace Weknow
{
        ...
        ICypherable
    {
        ...
        /// </example>
        IFluentCypherExpression Where(string statement);
        ...
        /// <returns></returns>
        IFluentCypherExpression Where(string variable, string name, params string[] moreNames);
        ...
        /// <returns></returns>
        IFluentCypherExpression Where(string variable, string name, IEnumerable<string> moreNames);
        ...
        /// </example>
        IFluentCypherExpression Where<T>(
