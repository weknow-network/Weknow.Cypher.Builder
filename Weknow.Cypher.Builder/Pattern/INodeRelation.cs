...
public interface INodeRelation : IPattern
{
    ...
    /// </returns>
    public static INode operator -(INodeRelation r1, INodeRelation r2) => throw new NotImplementedException();
    /// <summary>
    /// Declaration for operator -.
    /// </summary>
    /// <param name="r1"></param>
    ...
    /// The result of the operator.
    /// </returns>
    public static INode operator -(INodeRelation r1, INode r2) => throw new NotImplementedException();
    /// <summary>
    /// Declaration for operator -.
    /// </summary>
    /// <param name="r1"></param>
    ...
    /// The result of the operator.
    /// </returns>
    public static INodeRelation operator -(INode r1, INodeRelation r2) => throw new NotImplementedException();
    /// <summary>
